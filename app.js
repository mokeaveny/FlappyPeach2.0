...
// This function is called in the gameOver() function and makes the post request.
function sendJSON()
{
    const uri = 'http://api.thepeachproject.io/post_scores'

    const scoreObj = {
        username: 'randomusername',
        email: 'testemail@codesuite.co.uk',
        score: scoreTotal
    };
